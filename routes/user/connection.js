...
router.get("/connection/:id*?", async (req, res) => {
    try {
        ...
        // only getting active connection
        if (req.params.id) {
        ...
        // getting all the connection including active and pending
        else {
...
// to remove or reject connection
